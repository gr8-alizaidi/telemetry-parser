# CLAUDE.md — Telemetry Demo

Generated by Decispher. Do not edit. Source of truth: `.decispher/`.

> **Custom instructions for this agent**: if `user_agent_instruction_claude.md` exists next to this file, read it now — it holds project-specific instructions from this team that are not part of the generated context map. To add your own, create or edit that file directly; it is never regenerated or overwritten.
